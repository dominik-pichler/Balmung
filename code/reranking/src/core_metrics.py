...
#
"""======NOTE STUDENT==========
Due to the fira dataset also containing non-ascii values (the lines with the dbpedia entries, 
starting at around row 6000), we edited the load_qrels function
"""
def load_qrels_given(path):
