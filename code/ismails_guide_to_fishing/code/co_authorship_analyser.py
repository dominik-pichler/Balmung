...
# Open the nodes file
with open(f"./graph_data/nodes_{query_keyword}.csv", "w", encoding="utf8", newline="") as nodes_file:
...
with open(f"./edges_{query_keyword}.csv", "w", encoding="utf8", newline="") as edge_file:
